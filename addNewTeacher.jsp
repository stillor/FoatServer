...
<link rel="stylesheet" type="text/css" href="add_teacher.css">
<!--[if IE 7]>
...
<div class="clear"></div>	
	<form id="addTeacherForm" action="process?action=addNewTeacher" method="post" class="form form-horizontal responsive">
		<h2 style="text-align:center">添加新教师账号</h2>
		<div class="line"></div>
		<div style="height:10px"></div>
	    <div style="text-align:center; margin:0 auto" class="row cl">
				<label class="form-label col-4">ID：</label>
		...
		<div style="height:10px"></div>
		<div style="text-align:center; margin:0 auto" class="row cl">
				<label class="form-label col-4">密码：</label>
				<div class="formControls col-4">
		...
		<div style="height:10px"></div>
		<div style="text-align:center; margin:0 auto" class="row cl">
				<label class="form-label col-4">再次输入密码：</label>
				<div class="formControls col-4">
					<input type="password" class="input-text"  name="password_again">
				</div>
				<div class="col-5"> </div>
		</div>
		<div style="height:10px"></div>
