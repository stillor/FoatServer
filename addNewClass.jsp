...
<div class="clear"></div>
	...
	<form id="addClassForm" action="process?action=addNewClass" method="post" class="form form-horizontal responsive">
		<h2 style="text-align:center">添加新班级</h2>
		<div class="line"></div>
		<div style="height:10px"></div>
	    <div style="text-align:center; margin:0 auto" class="row cl">
				<label class="form-label col-4">班级名称：</label>
				<div class="formControls col-4">
					<input type="text" class="input-text"  name="className">
				</div>
				<div class="col-5"> </div>
		</div>
		<div style="height:10px"></div>
